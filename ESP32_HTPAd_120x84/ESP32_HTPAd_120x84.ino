...
*********************************************************************************************************/
char ssid[] = "group8-ELEC49X";   // Router configured for Capstone use only -- No internet connection
char pass[] = "capgroup8";
...
void loop() {
  ...
  if (state) { // state is 1 when all raw sensor voltages are read for this picture
    ...
    if (send_data) {
        ...
        // stop sending data until another request is sent 
        send_data = 0;
    }
